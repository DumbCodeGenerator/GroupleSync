...
package ru.krogon500.grouplesync.system_helper
 ...
 * extent to which the System UI's visibility is changed when you call [.hideView]
 * or [.toggle].
 */
...
@JvmOverloads constructor(activity: Activity, level: Int, flags: Int,
     ...
     *
     *
     * Any currently queued delayed hideView requests will be removed.
     */
    fun show() {
        // Ensure that any currently queued hideView calls are removed
 ...
 * bar](http://developer.android.com/design/patterns/actionbar.html), the most important structural element of an Android app, should
         ...
         * The bars automatically hideView again after a short delay, or if the user interacts with the
